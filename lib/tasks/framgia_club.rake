namespace :db do
  ...
  task seeding: :environment do
    ...
    bongda_club = Club.create!(
      ...
      content_club: "Câu lạc bộ bóng đá tại FramGia Đà Nẵng",
    ...
    tuthien_club = Club.create!(
      ...
      club_type: 0,
      organization_id: framgiadn.id,
      content_club: "Câu lạc bộ từ thiện tại FramGia Đà Nẵng",
    ...
    game_club = Club.create!(
      ...
      club_type: 2,
      organization_id: framgiadn.id,
      content_club: "Câu lạc bộ game tại FramGia Đà Nẵng",
      goal: "Mục tiêu câu lạc bộ giải trí",
      money: 0
    )
    tiengnhat_club = Club.create!(
      ...
      club_type: 1,
      organization_id: framgiadn.id,
      content_club: "Câu lạc bộ tiếng nhật tại FramGia Đà Nẵng",
    ...
    framgiafc = Club.create!(
      ...
      content_club: "Câu lạc bộ tại FramGia Hà Nội",
      goal: "Mục tiêu câu lạc bộ giải trí",
      money: 0
    )
    gameclub = Club.create!(
      ...
      club_type: 1,
      organization_id: framgiahn.id,
      content_club: "Câu lạc bộ game tại FramGia Hà Nội",
      goal: "Mục tiêu câu lạc bộ giải trí",
      money: 0
    )
    japaneseclub = Club.create!(
      ...
      club_type: 3,
      organization_id: framgiahn.id,
      content_club: "Câu lạc bộ tiếng nhật tại FramGia Hà Nội",
      goal: "Mục tiêu câu lạc bộ Học tập",
      money: 0
    )
    charityclub = Club.create!(
      ...
      club_type: 0,
      organization_id: framgiahn.id,
      content_club: "Câu lạc bộ từ thiện tại FramGia Hà Nội",
      goal: "Mục tiêu câu lạc bộ Từ thiện",
      money: 0
    )
    chinese_chess_club = Club.create!(
      ...
      club_type: 2,
      organization_id: framgiahn.id,
      content_club: "Câu lạc bộ cờ tướng tại FramGia Hà Nội",
      goal: "Mục tiêu câu lạc bộ giải trí",
      money: 0
    )
    dance_club = Club.create!(
      ...
      club_type: 5,
      organization_id: framgiahn.id,
      content_club: "Câu lạc bộ dance tại FramGia Hà Nội",
      goal: "Mục tiêu câu lạc bộ giải trí",
      money: 0
    )
    gymclub = Club.create!(
      ...
      club_type: 5,
      organization_id: framgiahn.id,
      content_club: "Câu lạc bộ Gym tại FramGia Hà Nội",
     ...
     japanese_food_club = Club.create!(
      ...
      club_type: 7,
      organization_id: framgiahn.id,
      content_club: "Câu lạc bộ Japanese Food tại FramGia Hà Nội",
    ...
    intellect_game_club = Club.create!(
      ...
      club_type: 2,
      organization_id: framgiahn.id,
      content_club: "Câu lạc bộ Intellect Game tại FramGia Hà Nội",
      goal: "Mục tiêu câu lạc bộ giải trí",
      money: 0
    )
     music_club = Club.create!(
      ...
      club_type: 4,
      organization_id: framgiahn.id,
      content_club: "Câu lạc bộ âm nhạc tại FramGia Hà Nội",
      goal: "Mục tiêu câu lạc bộ giải trí",
      money: 0
    )
